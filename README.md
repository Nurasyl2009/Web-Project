...
- Пайдаланылған әдебиеттер тізімі: `REFERENCES.md`
...
Толық тізім `REFERENCES.md` файлында келтірілген. Онда жобада қолданылған React, Node.js, Express, PostgreSQL және басқа да технологиялардың ресми құжаттамаларына сілтемелер бар.
